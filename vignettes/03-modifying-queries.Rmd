...
This vignette starts with a query that downloads Alternative Claimant Count
(ACC) claimant counts for **age 16 in England in August 2022** and modifies
it to instead download the same data for **age 17 in Wales**.
